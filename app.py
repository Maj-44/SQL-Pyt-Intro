...
##### STREAMLIT #####
st.set_page_config(page_title="Paris Price Estimator", layout="wide")
st.title("🏡 Paris House Price Estimator")
...
def load_model():
    try:
        ...
        st.warning("Model file not found. Upload model or train and save as 'house_price_model.pkl'.")
        return None
...
with st.sidebar.form("input_form"):
    postal = st.selectbox("Postal Code", [
    "75001", "75002", "75003", "75004", "75005", "75006", "75007", "75008", "75009", "75010",
    "75011", "75012", "75013", "75014", "75015", "75016", "75017", "75018", "75019", "75020"
])
    rooms = st.slider("Number of rooms", 1, 10, 3)
    square = st.slider("Area (m²)", 10, 300, 70)
    floors = st.number_input("Number of floors", value=1, min_value=0)
...
if submit:
    input_df = pd.DataFrame([{
        ...
        "squareMeters": square,
        "floors": floors,
        "hasBalcony": int(balcony),
        "hasElevator": int(elevator),
        "hasParking": int(parking)
    }])
